document.addEventListener('DOMContentLoaded', () => {
    ...
    if (loggedIn) {
        navbar.innerHTML = `<a class="navbar-brand" href="#"><img src="play_mark2.png" alt="Logo" height="50px" width="50px">Video Library</a>${emailAddress}<input type="text" class="Search" name="varSearch" placeholder="Search..."><button class="btn btn-primary" type="login" value="Login">Log Out</button>`;
